...
atomjoinSource
    : tableSource lateralOrPivotView*
    | virtualTableSource lateralOrPivotView*
    | subQuerySource lateralOrPivotView*
    | partitionedTableFunction lateralOrPivotView*
...
joinSourcePart
    : (tableSource | virtualTableSource | subQuerySource | partitionedTableFunction) lateralOrPivotView*
    ;
...
lateralViewWithView
    : KW_LATERAL KW_VIEW KW_OUTER? function_ tableAlias?
      (KW_AS aliasList)?
    ;

lateralViewWithTable
    : KW_LATERAL KW_TABLE LPAREN valuesClause RPAREN
      KW_AS? tableAlias (LPAREN aliasList RPAREN)?
    ;

pivotView
    : KW_PIVOT LPAREN
        (asExpression (COMMA asExpression)*)?
      KW_FOR columnNameList KW_IN multiNamedExpression
      RPAREN
    ;

lateralOrPivotView
    : COMMA? (lateralViewWithView | lateralViewWithTable | pivotView)
    ;
...
*/
virtualTableSource
    : KW_TABLE LPAREN valuesClause RPAREN KW_AS? tableAlias (LPAREN aliasList RPAREN)?
    ;
