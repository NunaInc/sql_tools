...
// starting rule
statements
   : (statement (statementSeparator statement)* | empty_)* EOF
   ;
...
grantRole
    : KW_GRANT KW_ROLE? aliasList KW_TO principalSpecification withAdminOption?
    ;

revokeRole
    : KW_REVOKE adminOptionFor? KW_ROLE? aliasList KW_FROM principalSpecification
    ;
