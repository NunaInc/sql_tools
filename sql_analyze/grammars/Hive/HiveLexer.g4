...
KW_TRANSFORM_KEYS : T R A N S F O R M '_' K E Y S;
KW_TRANSFORM_VALUES : T R A N S F O R M '_' V A L U E S;
KW_FILTER : F I L T E R;
KW_ARRAY_SORT : A R R A Y '_' S O R T;
KW_ZIP_WITH : Z I P '_' W I T H;
KW_AGGREGATE : A G G R E G A T E;
KW_FORALL : F O R '_' A L L;
KW_MAP_FILTER : M A P '_' F I L T E R;
KW_MAP_ZIP_WITH : M A P '_' Z I P '_' W I T H;
KW_USING: U S I N G;
...
KW_UTC: U T C;
KW_UTCTIMESTAMP: U T C '_' T I M E S T A M P;
KW_LONG: L O N G;
